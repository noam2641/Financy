...
- **CX-11 Governance independence.** A6 (Grade A, SR 11-7/26-2). Single-proposer but uncontradicted; corroborated by the spec's own REQ-GOV-002/REQ-KILL-001. **Consensus: solo operation caps at RESEARCH/SHADOW; PAPER/LIVE need external effective challenge + two-person kill-switch.**
